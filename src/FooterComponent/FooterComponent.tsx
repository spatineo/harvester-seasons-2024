...
const FooterComponent: FC = () => {
  return (
    <Box sx={footerStyle.container}>
      ...
      <Link href="https://www.linkedin.com/showcase/harvester-seasons" target="_blank" sx={footerStyle.link}>
        <Button>
          <Box component="img" src={linkedin} sx={footerStyle.image}/>
          <Typography component={'span'} sx={footerStyle.text}>Follow us on LinkedIn</Typography>
        </Button>
      </Link>
      <Link href="../privacy-policy/" target="_blank" sx={footerStyle.link}> 
        <Button>
          <Typography sx={footerStyle.text}>Privacy Policy / Terms <span>of Use</span></Typography>
        </Button>
        </Link>
    </Box>
  )
