...
export function* fetchSoilWetnessDataSaga ({ payload }: ReturnType<typeof actions.setSoilWetnessData>): SagaIterator {
  ...
  const modifiedEndDate =  Number(`${end_time[2]}${end_time[1]}${end_time[0]}0000`)
  try {
    const url = `https://sm.harvesterseasons.com/timeseries?latlon=64,27&param=utctime,VSW-M3M3:ECBSF:5022:9:7:0:0,VSW-M3M3:ECBSF:5022:9:7:0:1,VSW-M3M3:ECBSF:5022:9:7:0:2,VSW-M3M3:ECBSF:5022:9:7:0:3,VSW-M3M3:ECBSF:5022:9:7:0:4,DIFF{VSW-M3M3:ECBSF:5022:9:7:0:0;-0.0305226445198059},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:1;-0.0305470526218414},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:2;-0.0306599736213684},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:3;-0.007231593132019},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:4;-0.0304692387580872},SWVL2-M3M3:SMARTMET:5015&starttime=${modifiedStartDate}&endtime=${modifiedEndDate}&timestep=1440&timeformat=sql&precision=full&separator=,&source=grid&tz=utc&format=json`
  ...
  export function* fetchSnowHeightDataSaga ({ payload }: ReturnType<typeof actions.setSnowHeightData>): SagaIterator {
    ...
    const modifiedEndDate =  Number(`${end_time[2]}${end_time[1]}${end_time[0]}0000`)
    try {
      const url = `https://sm.harvesterseasons.com/timeseries?latlon=64,27&param=utctime,SD-M:ECBSF::1:0:1:0,SD-M:ECBSF::1:0:3:1,SD-M:ECBSF::1:0:3:2,SD-M:ECBSF::1:0:3:3,SD-M:ECBSF::1:0:3:4,DIFF{SD-M:ECBSF::1:0:1:0;-0.0640000104904175},DIFF{SD-M:ECBSF::1:0:3:1;-0.0640000104904175},DIFF{SD-M:ECBSF::1:0:3:2;0.0141249895095825},DIFF{SD-M:ECBSF::1:0:3:3;-0.0640000104904175},DIFF{SD-M:ECBSF::1:0:3:4;-0.0171250104904175},HSNOW-M:SMARTOBS:13:4&starttime=${modifiedStartDate}&endtime=${modifiedEndDate}&timestep=1440&timeformat=xml&precision=full&source=grid&tz=utc&format=json`
     const response = yield call(axios.get, url)
     if(response.status === 200) {
