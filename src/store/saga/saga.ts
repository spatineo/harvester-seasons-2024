...
export function* fetchSoilWetnessDataSaga ({ payload }: ReturnType<typeof actions.setSoilWetnessData>): SagaIterator {
  ...
  try {
    const response = yield call(axios.get, 
    `https://sm.harvesterseasons.com/timeseries?latlon=64,27&param=utctime,VSW-M3M3:ECBSF:5022:9:7:0:0,VSW-M3M3:ECBSF:5022:9:7:0:1,VSW-M3M3:ECBSF:5022:9:7:0:2,VSW-M3M3:ECBSF:5022:9:7:0:3,VSW-M3M3:ECBSF:5022:9:7:0:4,DIFF{VSW-M3M3:ECBSF:5022:9:7:0:0;-0.0305226445198059},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:1;-0.0305470526218414},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:2;-0.0306599736213684},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:3;-0.007231593132019},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:4;-0.0304692387580872},SWVL2-M3M3:SMARTMET:5015&starttime=${modifiedStartDate}&endtime=${modifiedEndDate}&timestep=1440&timeformat=sql&precision=full&separator=,&source=grid&tz=utc&format=json`)
    if(response.status === 200) {
  ...
  export function* fetchSnowHeightDataSaga ({ payload }: ReturnType<typeof actions.setSnowHeightData>): SagaIterator {
    ...
    try {
     const response = yield call(axios.get, 
     `https://sm.harvesterseasons.com/timeseries?latlon=64,27&param=utctime,VSW-M3M3:ECBSF:5022:9:7:0:0,VSW-M3M3:ECBSF:5022:9:7:0:1,VSW-M3M3:ECBSF:5022:9:7:0:2,
     VSW-M3M3:ECBSF:5022:9:7:0:3,VSW-M3M3:ECBSF:5022:9:7:0:4,DIFF{VSW-M3M3:ECBSF:5022:9:7:0:0;-0.0305226445198059},DIFF{VSW-M3M3:ECBSF:5022:9:7:0:1;-0.0305470526218414},
     ...
     SWVL2-M3M3:SMARTMET:5015&starttime=${modifiedStartDate}&endtime=${modifiedEndDate}&timestep=1440&timeformat=sql&precision=full&separator=,&source=grid&tz=utc&format=json
     `)
     if(response.status === 200) {
