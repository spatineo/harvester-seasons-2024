...
const initialState: GlobalStateProps = {
  ...
  params: {
    ...
    snowHeight: [
      ...
      { code: "HSNOW-M:ECBSF::1:0:1:0", layerName: "harvester:ecbsf:HSNOW-M" },
      ...[...Array(50).keys()].map((n) => ({ code: `HSNOW-M:ECBSF::1:0:3:${n+1}`, layerName: "harvester:ecbsf:HSNOW-M" })),
    ...
    soilTemperature: [
      ...
      { code: "TSOIL-C:ECBSF:::7:1:0", layerName: "harvester:ecbsf:TSOIL-C" },
      ...[...Array(50).keys()].map((n) => ({ code: `TSOIL-C:ECBSF:::7:3:${n+1}`, layerName: "harvester:ecbsf:TSOIL-C" })),
    ...
    soilWetness: [
      ...
      ...[...Array(51).keys()].map((n) => ({ code: `SWI2-0TO1:ECXSF:5062:1:0:0:${n}`, layerName: "harvester:ecxsf:SWI2-0TO1" })),
